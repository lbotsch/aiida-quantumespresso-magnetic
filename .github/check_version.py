...
Check version number in setup.json and aiida_quantumespresso_magnetic/__init__.py and make sure
they match.
"""
...
import aiida_quantumespresso_magnetic  # pylint: disable=wrong-import-position
version = aiida_quantumespresso_magnetic.__version__
...
if version != setup_content['version']:
    ...
    print("Version number in '{}/__init__.py': {}".format(
        'aiida_quantumespresso_magnetic', version))
    sys.exit(1)
