...
class DiffCalculation(CalcJob):
    ...
    def define(cls, spec):
        ...
        spec.inputs['metadata']['options']['parser_name'].default = 'quantumespresso_magnetic'
        ...
        spec.output('quantumespresso_magnetic', valid_type=SinglefileData, help='diff between file1 and file2.')
